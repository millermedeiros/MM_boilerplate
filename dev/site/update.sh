...
# if it's using Handlebars.js instead of mustache.js
IS_HBS=false
...
# if $IS_HBS; then
    # echo "\n -- updating Handlebars.js --\n"
    # curl https://raw.github.com/SlexAxton/require-handlebars-plugin/master/Handlebars.js > js/lib/Handlebars.js
# else
...
# if $IS_HBS; then
    ...
    # curl https://raw.github.com/SlexAxton/require-handlebars-plugin/master/hbs.js > js/lib/require/hbs.js
# fi
...
# curl https://raw.github.com/jrburke/r.js/master/dist/r.js > _build/rjs/r.js
